/*
  ==============================================================================
    ...
    IPCServer.h
    Created: 14 Mar 2021 10:02:39pm
...
public:
    ...
    juce::InterprocessConnection *createConnectionObject() override
    {
        ...
        client_connection.get()->SetConnectionMadeCallback(std::bind(&IPCServer::ConnectionMadeCallback, this));
